...
import br.edu.up.projetofinal.models.Genero;
...
public class GeneroView {
    ...
    private static void exibirEscolha(Scanner scanner, int op) {
        switch (op) {
            ...
            case 1 -> cadastrarGenero(scanner);
            case 2 -> atualizarGenero(scanner);
            case 3 -> removerGenero(scanner);
            case 4 -> listarGenero();
    ...
    private static void cadastrarGenero(Scanner scanner) {
        try {
            ...
            LivroController.cadastrar(genero);
    ...
    private static void atualizarGenero(Scanner scanner) {
        try {
            listarGenero();
    ...
    private static void removerGenero(Scanner scanner) {
        try {
            listarGenero();
